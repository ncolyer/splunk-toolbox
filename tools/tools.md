...
graph TD;
    ...
    A --> B[<a href="https://github.com/ncolyer/splunk-toolbox/blob/main/data/speculative_data_modeling.md" target="_blank" style="color:white">speculative_data_modeling</a>]:::secondLevelStyle
