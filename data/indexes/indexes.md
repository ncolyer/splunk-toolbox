...
graph TD;
    ...
    Z --> A[indexes]:::firstLevelStyle
    A --> B[metric_indexes]:::secondLevelStyleMissing
    A --> C[raw_data_storage]:::secondLevelStyleMissing
    A --> D[summary_indexes]:::secondLevelStyleMissing
